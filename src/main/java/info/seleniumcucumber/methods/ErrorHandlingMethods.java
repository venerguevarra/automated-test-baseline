...
public class ErrorHandlingMethods {
    ...
    public void printErrorAndroid(String browserType, String appPath) {
        /*
         * if browser_type=='ff' and app_path==nil puts
         * "\nOops... not mentioned \"Browser\" or \"App path\""
         * print_error_android_app print_error_android_web Process.exit(0) elsif
         * browser_type!='ff' and !%w(native chrome).include? browser_type puts
         * "\nOops... not supported browser" print_error_android_web
         * Process.exit(0) end end
         */
    }
